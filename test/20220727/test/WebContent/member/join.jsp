...
<body>
	...
	<div id="joinForm_wrap">
		<form action="joinPro.jsp" method="post" name="frmJoin" onsubmit="return infoConfirm()">
			<div id="join_title">홈쇼핑 회원 등록</div>
			<table>
				<tr>
					<th>회원번호(자동발생)</th>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="custname" class="custname" id="custname">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="date" name="tempJoindate" class="tempJoindate" id="tempJoindate">
					</td>
				</tr>
				<tr>
					<th><label for="grade">고객 등급<br>(A:Vip, B:일반, C:직원)</label></th>
					<td>
						<input type="text" name="grade" class="grade" id="grade">
					</td>
				</tr>
				<tr>

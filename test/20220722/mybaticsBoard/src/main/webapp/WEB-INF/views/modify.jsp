...
<body>
	<form action="${conPath }/modify.do" method="post">
		...
		<table>
			...
			<tr>
				<th>작성자</th>
				<td><input type="text" name="bname" required="required" value="${boardDto.bname }"></td>
			</tr>
			<tr>
				<th>제목</th>
				<td><input type="text" name="btitle" required="required" value="${boardDto.btitle }"></td>
			</tr>
			<tr>
				<th>본문</th>
				<td><textarea rows="5" cols="20" name="bcontent">${boardDto.bcontent }</textarea></td>
			</tr>
			<tr>
				<td colspan="2">

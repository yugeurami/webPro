	...
	<div id="content">
		<form action="book.do" method="post" enctype="multipart/form-data">
			...
			<table>
				...
				<tr>
					<th>출판일</th>
					<td><input type="text" id="datepicker" name="brdate" required="required"></td>
				</tr>
				<tr>
					<th>책 이미지 1</th>
				...
				<tr>
					<td colspan="2">
						<input type="button" value="도서목록으로" class="btn"
							onclick="location.href='book.do?method=list&pageNum=1'">

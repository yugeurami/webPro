...
INSERT INTO ORDERS VALUES ( 
    TO_CHAR(SYSDATE, 'YYMMDD')||TRIM(TO_CHAR(ORDERS_SEQ.NEXTVAL, '0000')),
    'abc',SYSDATE,'서울시 강남구', '010-1111-1111');
INSERT INTO ORDERS VALUES ( 
   TO_CHAR(SYSDATE, 'YYMMDD')||TRIM(TO_CHAR(ORDERS_SEQ.NEXTVAL, '0000')),
    'def', SYSDATE, '서울시 서대문구', '010-2222-2222');
INSERT INTO ORDERS VALUES ( 
    TO_CHAR(SYSDATE, 'YYMMDD')||TRIM(TO_CHAR(ORDERS_SEQ.NEXTVAL, '0000')),
    'abc',SYSDATE,'경기도 과천', '010-3333-3333');
SELECT * FROM ORDERS;                
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 2204201, 'A1', 3,
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 220420001, 'B1', 1,
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 220420001, 'A2', 2,
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 220420001, 'B2', 1,
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 2204200002, 'A2', 2,
                (SELECT PRICE FROM PRODUCT WHERE CODE= 'A2')*2);
UPDATE PRODUCT
    SET STOCK = STOCK - 2
    WHERE CODE = 'A2';  
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 2204200002, 'B2', 1,
                (SELECT PRICE FROM PRODUCT WHERE CODE= 'B2')*1);
UPDATE PRODUCT
    SET STOCK = STOCK - 1
    WHERE CODE = 'B2';  
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 2204200002, 'C1', 1,
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 2204200003, 'A1', 2,
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 2204200003, 'B1', 1,
                (SELECT PRICE FROM PRODUCT WHERE CODE= 'B1')*1);
UPDATE PRODUCT
    SET STOCK = STOCK - 1
    WHERE CODE = 'B1';  
...
INSERT INTO ORDER_DETAIL
    VALUES (ORDER_DETAIL_SEQ.NEXTVAL, 2204200003, 'C1', 1,
                (SELECT PRICE FROM PRODUCT WHERE CODE= 'C1')*1);
UPDATE PRODUCT
    SET STOCK = STOCK - 1
    WHERE CODE = 'C1';
